...
namespace EventBus.AzureServiceBus
{
    public class EventBusServiceBus : BaseEventBus
    {
        ...
        public override void Subscription<T, TH>()
        {
            ...
            logger.LogInformation($"Subscriping to event {eventName} with {typeof(TH).Name}");
        ...
        private Task ExceptionReceivedHandler(ExceptionReceivedEventArgs exceptionReceivedEventArgs)
        {
            ...
            logger.LogError(ex, $"Error handling message: {ex.Message} - {context}");
        ...
        public override void UnSubscription<T, TH>()
        {
            ...
            {
                logger.LogWarning($"The messaging entity {eventName} could not found.");
            }

            logger.LogInformation($"UnSubscriping from event {eventName} with {typeof(TH).Name}");
        ...
        private void RemoveDefaultRule(SubscriptionClient subscriptionClient)
        {
            ...
            {
                logger.LogWarning($"The messaging entity {RuleDescription.DefaultRuleName} coult not be found");
            }
        }
