...
namespace EventBus.Base.SubManager
{
    public class InMemoryEventBusSubscriptionManager : IEventBusSubscriptionManager
    {
        ...
        {
            if (!HasSubsctiptionsForEvent(eventName))
            {
        ...
        public void RemovedSubscription<T, TH>()
            where T : IntegrationEvent
            where TH : IIntegrationEventHandler<T>
        {
        ...
        private SubscriptionInfo FindSubscriptionToRemove(string eventName, Type handlerType)
        {
            ...
            return _handlers[eventName].SingleOrDefault(x => x.HandleType == handlerType);
        }
        ...
        public bool HasSubsctiptionsForEvent<T>() where T : IntegrationEvent
        {
            var key = GetEventKey<T>();

            return HasSubsctiptionsForEvent(key);
        }



        public bool HasSubsctiptionsForEvent(string eventName)
        {
